package com.wzdsqyy.jsbridgedemo.fragment;
...
import com.wzdsqyy.jsbridgedemo.IInvokeJS;
import com.wzdsqyy.jsbridgedemo.JavaInterfaces4JS;
import com.wzdsqyy.jsbridgedemo.R;
...
public class WebViewFragment extends Fragment {
    ...
    public void initData() {
        ...
        mSimpleJavaJsBridge = new Builder().addJavaInterface4JS(javaInterfaces4JS)
                .setWebView(mWebView)
                .setJSMethodName4Java("_JSNativeBridge._handleMessageFromNative")
                .setProtocol("niu","receive_msg").create();
        invokeJS = mSimpleJavaJsBridge.createInvokJSCommand(IInvokeJS.class);
    }
