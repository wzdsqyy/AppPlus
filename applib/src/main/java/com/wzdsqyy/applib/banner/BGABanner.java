package com.wzdsqyy.applib.banner;
...
import com.wzdsqyy.applib.transformer.BGAPageTransformer;
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (mTipTv != null && mTips != null) {
            if (positionOffset > 0.5) {
                ...
                BGAPageTransformer.setAlpha(mTipTv, positionOffset);
            } else {
                BGAPageTransformer.setAlpha(mTipTv, 1 - positionOffset);
