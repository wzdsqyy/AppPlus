...
public class ExpandViewHelper {
    ...
    private ExpandViewHelper(Builder builder) {
    ...
    private final class LineProperty extends Property<ExpandViewHelper, Integer> {
        private String name;
        ...
        @Override
        public Integer get(ExpandViewHelper object) {
            return object.getLines();
        }
        @Override
        public void set(ExpandViewHelper object, Integer value) {
    ...
    private void setLines(int lines) {
        builder.viewGroup.requestDisallowInterceptTouchEvent();
    ...
    public ExpandViewHelper onLineFinishListener(OnLineFinishListener onLineFinishListener) {
    ...
    public static class Builder {
        ...
        public ExpandViewHelper build() {
            ...
            return new ExpandViewHelper(this);
        }
    }
}