...
public class UpdateInfo {
    public boolean hasUpdate = false;// 是否有新版本
    public boolean isSilent = false;  // 是否静默下载：有新版本时不提示直接下载，下次启动时安装
    public boolean isForce = false; // 是否强制安装：不安装无法使用app
    public boolean isIgnorable = true; // 是否可忽略该版本
    public boolean isPatch = false;// 是否是增量补丁包
