...
public class StatusBarUtil {
    ...
    public static void setColor(Activity activity, @ColorInt int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            View statusbar = decorView.findViewById(R.id.statusbar_view);
            if (statusbar == null) {
                View statusView = createStatusBarView(activity);
                statusbar.setId(R.id.statusbar_view);
                decorView.addView(statusView);
            }
            statusbar.setBackgroundColor(calculateStatusColor(color, statusBarAlpha));
    ...
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, @ColorInt int color,
        ...
        View drawer = contentLayout.findViewById(R.id.drawerLayout_view);
        if (drawer == null) {
            View statusBarView = createStatusBarView(activity, color);
            statusBarView.setId(R.id.drawerLayout_view);
    ...
    public static void setColorForDrawerLayoutDiff(Activity activity, DrawerLayout drawerLayout, @ColorInt int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            View drawer = contentLayout.findViewById(R.id.drawerLayout_view);
            if (drawer == null) {
                View statusBarView = createStatusBarView(activity, DEFAULT_STATUS_BAR_ALPHA);
                statusBarView.setId(R.id.drawerLayout_view);
                contentLayout.addView(statusBarView, 0);
            }
            drawer.setBackgroundColor(color);
