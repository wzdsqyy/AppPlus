...
public class SwipeBackLayout extends FrameLayout {
     ...
     * 绑定 Fragment
     */
    public SwipeBackLayout attachActivity(Fragment fragment) {
    ...
    public SwipeBackLayout setOnSwipeBackListener(OnSwipeBackListener onSwipeBackListener) {
